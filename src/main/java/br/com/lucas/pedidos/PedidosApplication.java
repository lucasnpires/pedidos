...
public class PedidosApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Produto p4 = new Produto(null, "Mesa de Escritório", new BigDecimal(300.00D));
		Produto p5 = new Produto(null, "Toalha", new BigDecimal(50.00D));
		Produto p6 = new Produto(null, "Colcha", new BigDecimal(200.00D));
		Produto p7 = new Produto(null, "TV True Color", new BigDecimal(1200.00D));
		Produto p8 = new Produto(null, "Roçadeira", new BigDecimal(800.00D));
		Produto p9 = new Produto(null, "Abajour", new BigDecimal(100.00D));
		Produto p10 = new Produto(null, "Pendente", new BigDecimal(180.00D));
		Produto p11 = new Produto(null, "Shampoo", new BigDecimal(90.00D));
		...
		Pagamento pagto1 = new PagamentoComCartoes(null, EstadoPagamento.QUITADO, ped1, 6);
